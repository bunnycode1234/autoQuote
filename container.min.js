    ...
    window.CQ.CoreComponents.container.utils = {
        getDeepLinkItemIdx: function (a, b) {
            if (window.location.hash) {
                ...
                if (document.getElementById(c) && c && a && a._config && a._config.element && a._config.element.id && a._elements && a._elements[b] && 0 === c.indexOf(a._config.element.id + "-item-"))
                    for (var d = 0; d < a._elements[b].length; d++)
                        if (a._elements[b][d].id === c)
                            return d;
                return -1
            }
        },
        getDeepLinkItem: function (a, b) {
            ...
            if (a && a._elements && a._elements[b])
                return a._elements[b][c]
        },
